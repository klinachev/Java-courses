...
//                    System.out.println("GET: " + var8);
    ...
    static {
        ...
        ANSWER = List.of("Hello, %s", "%s ????????", "?????, %s", "????? %s", "Салом %s", "Здраво %s", "Здравейте %s", "Прывітанне %s", "Привіт %s", "Привет, %s", "Поздрав %s", "???? ?? %s", "???? %s", "???? ??? %s", "???? %s", "???%s? ?", "Bonjou %s", "Bonjour %s", "Bun? ziua %s", "Ciao %s", "Dia duit %s", "Dobr? de? %s", "Dobr? den, %s", "Habari %s", "Hall? %s", "Hallo %s", "Halo %s", "Hei %s", "Hej %s", "Hello  %s", "Hello %s", "Hello %s", "Helo %s", "Hola %s", "Kaixo %s", "Kamusta %s", "Merhaba %s", "Ol? %s", "Ola %s", "P?rsh?ndetje %s", "Pozdrav %s", "Pozdravljeni %s", "Salom %s", "Sawubona %s", "Sveiki %s", "Tere %s", "Witaj %s", "Xin ch?o %s", "??????? %s", "?????? %s", "???? %s", "????? %s", "??? %s", "???? %s", "???????%s??", "?????? %s", "???? %s", "???? %s", "??????? %s", "??? %s ?????????", "????????? %s", "???????? %s ???", "?????%s", "??%s", "?????  %s");
